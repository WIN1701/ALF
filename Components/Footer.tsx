    ...
    <footer className="border-t border-white/10 bg-black px-5 py-12 text-white">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 text-center md:flex-row">
        ...
        <a
          ...
          className="flex min-h-11 items-center gap-2 rounded-full border border-green-700/50 px-6 text-xs font-black uppercase text-green-500"
        >
      ...
      <p className="mx-auto mt-10 max-w-7xl border-t border-white/10 pt-6 text-center text-xs text-zinc-600">
